...
namespace _10_medical_agent_api.Infrastructure;
...
/// - Builds an in-memory vector index at startup from the pipe-delimited acronyms.md file.
...
public class SemanticMedicalSearch : IDisposable
{
    ...
    /// <summary>
    /// Loads and indexes the pipe-delimited acronyms.md file.
    ...
    public void Dispose()
    {
        // LocalEmbedder is injected and owned by the caller (DI container),
